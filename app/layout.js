...
export const metadata = {
  ...
  title: {
    default: 'Rosiya A.S | Portfolio',
    template: '%s | Rosiya A.S',
  },
  description:
    'AI & Data Science graduate skilled in Python, Machine Learning, Deep Learning, and Analytics. Open to full-time opportunities worldwide.',
  keywords: [
    'Rosiya A.S',
    'AI Engineer',
    'Data Scientist',
  ...
  authors: [{ name: 'Rosiya A.S', url: SITE_URL }],
  creator: 'Rosiya A.S',
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Rosiya A.S | AI & Data Science Portfolio',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'Rosiya A.S',
              url: SITE_URL,
              email: 'roger.rosiya04@gmail.com',
              jobTitle: 'AI & Data Science Graduate',
              sameAs: [
                'https://github.com/RosiyaAS',
                'https://www.linkedin.com/in/rosiya-a-s-44a76829b/',
              ],
            }),
          }}
        />
